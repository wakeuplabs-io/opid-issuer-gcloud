...
export ETHEREUM_URL='URL LINK OF BLOCKCHAIN NETWORK'
...
export RHS_MODE="None"                                   # None| OnChain | OffChain
export RHS_URL="https://rhs-staging.polygonid.me/"       # Reuired if RHS_MODE is OffChain
```
